...
/// Бинарный формат — это когда данные пишутся прямо в байтах, а не как текст.
/// Это компактнее и быстрее, но "глазами" такой файл не прочитать.
/// Все числа здесь пишутся в формате Big-Endian (BE).
